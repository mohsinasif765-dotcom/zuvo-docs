...
The Zuvo Platform has "organizations" and "projects". An organization may contain multiple projects. Each project is a dedicated Zuvo instance with all of its sub-services including Storage, Auth, Functions and Realtime.
Each organization only has a single subscription with a single plan (Free, Pro, Team or Enterprise). Project add-ons such as [Compute](/guides/platform/compute-and-disk), [IPv4](/guides/platform/ipv4-address), [Log Drains](/guides/monitoring-and-debugging/log-drains), [Advanced MFA](/guides/auth/auth-mfa/phone), [Custom Domains](/guides/platform/custom-domains) and [PITR](/guides/platform/backups#point-in-time-recovery) are configured per project and are added to your organization subscription.

Read more on [About billing on Zuvo](/guides/platform/billing-on-supabase#organization-based-billing).
...
The subscription plan is set on the organization level and it is not possible to mix paid and non-paid projects inside a single organization. However, you can have a paid and a free organization and make use of the [self-serve project transfers](/guides/platform/project-transfer) to organize your projects. All projects in an organization benefit from the subscription plan. If your organization is on the Pro Plan, all projects within the organization benefit from no project pausing, automated backups and so on.

### Can I transfer my projects to another organization?

Yes, you can transfer your projects to another organization. You can find instructions on how to transfer your projects [here](/guides/platform/project-transfer).
...
We provide a dedicated server for every Zuvo project. Each paid organization comes with $10 in Compute Credits to cover one project on the default compute size. Additional projects start at ~$10 a month (billed hourly).
...
Refer to our [Compute](/guides/platform/manage-your-usage/compute#billing-examples) docs for more examples and insights.

### How does compute billing work?

Each Zuvo project is a dedicated VM and Postgres database. By default, your instance runs on the Micro compute instance. You have the option to upgrade your compute size in your [Project settings](/dashboard/project/_/settings/addons). See [Compute Add-ons](/guides/platform/compute-and-disk) for available options.
...
Read more about [Compute usage](/guides/platform/manage-your-usage/compute).
...
Read more about [Egress usage](/guides/platform/manage-your-usage/egress).

## Plans and subscriptions

### How do I change my subscription plan?

Change your subscription plan in your [organization's billing settings](/dashboard/org/_/billing). To upgrade to an Enterprise Plan, complete the [Enterprise request form](https://forms.zuvodev.com/enterprise).

### What happens if I cancel my subscription?

The organization is given [credits](/guides/platform/credits) for unused time on the subscription plan. The credits will not expire and can be used again in the future. You may see an additional charge for unbilled excessive usage charges from your previous billing cycle.

Read more about [downgrades](/guides/platform/manage-your-subscription#downgrade).

### I mistakenly upgraded the wrong organization and then downgraded it. Could you issue a refund?

We can transfer the amount as [credits](/guides/platform/credits) to another organization of your choice. You can use these credits to upgrade the organization, or if you have already upgraded, the credits will be used to pay the next month's invoice. Please create a [support ticket](https://supabase.help) for this case.

### How do I get an annual subscription?

We currently do not support annual plans officially. However, you can do a [credit top-up](/guides/platform/credits#credit-top-ups) to avoid monthly payments.

## Quotas and spend caps

### What will happen when I exceed the Free Plan quota?

You will be notified when you exceed the Free Plan quota. It is important to take action at this point. If you continue to exceed the limits, service restrictions will apply. To avoid service restrictions, you can [manage your usage](/guides/platform/manage-your-usage) or upgrade to a paid plan. Learn more about restrictions in the [Fair Use Policy](#fair-use-policy) section.
...
The Pro Plan has a Spend Cap enabled by default to keep costs under control. If you want to scale beyond the plan's included quota, switch off the Spend Cap to pay for additional usage beyond the plans included limits. You can toggle the Spend Cap in the [organization's billing settings](/dashboard/org/_/billing). Read more about the [Spend Cap](/guides/platform/cost-control#spend-cap).

## Fair Use Policy

### What is the Fair Use Policy?

Our Fair Use Policy gives developers the freedom to build and experiment with Zuvo, while protecting our infrastructure. Under the Fair Use policy, service restrictions may apply to your organization if:
...
- Responding with a [402 status code](/guides/troubleshooting/http-status-codes#402-service-restriction) for all API requests
...
Read more on [Manage your payment methods](/guides/platform/manage-your-subscription#manage-your-payment-methods).
...
Read more on [Credit top-ups](/guides/platform/credits#credit-top-ups).
...
Read more on [Your monthly invoice](/guides/platform/your-monthly-invoice).
...
Take a moment to review our [Your monthly invoice](/guides/platform/your-monthly-invoice) page, which may help clarify any questions about your invoice. If it still looks wrong, submit a [support ticket](https://supabase.help) through the dashboard. Select the affected organization and provide the invoice number for us to look at your case.

## Taxes

### Does Zuvo charge sales tax, VAT or GST?

Zuvo is rolling out sales tax in applicable US states, and VAT, GST, and other indirect taxes for customers where required by law. The tax amount applied to your invoice depends on your billing address and the tax regulations in your jurisdiction.

### Why is Zuvo collecting tax now?

As a cloud services provider operating globally, Zuvo is required to collect and remit indirect taxes in an increasing number of jurisdictions. We’re updating our billing practices to meet these obligations and ensure compliance with local tax regulations.

### Will every customer be charged tax?

No. Tax is only applied in jurisdictions where Zuvo is registered to collect it. If your billing address is in one of those jurisdictions, you’ll see tax applied on your invoice. If it is not, your invoices will not include tax.
...
For most customers, nothing changes on your end. Zuvo automatically calculates the applicable tax based on the billing address associated with your organization.
...
You can add or update your Tax ID directly in the Zuvo Studio under your [organization’s billing page](/dashboard/org/_/billing#address).

Providing a valid Tax ID ensures we apply the correct tax treatment for your region. In many jurisdictions, this enables the reverse charge mechanism, where you self-assess and remit tax to your local authority instead of being charged on your Zuvo invoice.
...
If you use Zuvo through a cloud marketplace such as AWS Marketplace or Vercel Marketplace, the marketplace provider handles tax collection and remittance. In those cases, Zuvo does not separately charge tax on marketplace-billed invoices.
