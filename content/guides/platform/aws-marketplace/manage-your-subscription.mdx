...
Plan changes are not made on the Zuvo dashboard, but instead through the AWS Marketplace. The easiest way to navigate to the corresponding page on the marketplace is through the Zuvo dashboard.
...
![AWS Marketplace modify contract page](/img/guides/platform/aws-marketplace-change-plan.png)
...
![AWS Marketplace modify contract page](/img/guides/platform/aws-marketplace-configure-auto-renewal.png)
