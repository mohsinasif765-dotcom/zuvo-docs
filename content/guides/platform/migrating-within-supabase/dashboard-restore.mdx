...
subtitle: 'Learn how to restore your dashboard backup to a new Zuvo project'
...
Dashboard backups are only available for older projects that still use logical backups. Projects that use physical backups should follow steps in [Backup and Restore using the CLI](/guides/platform/migrating-within-supabase/backup-restore).
    ...
    >
      ...
      <StepHikeCompact.Step step={1}>
        <StepHikeCompact.Details title="Create New project" fullWidth>
          Create a new [Zuvo project](https://database.new)
        </StepHikeCompact.Details>
      </StepHikeCompact.Step>
        <StepHikeCompact.Step step={2}>
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/PLyn/supabase-storage-migrate/blob/main/Zuvo_Storage_migration.ipynb)
