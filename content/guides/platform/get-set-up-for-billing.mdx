...
For more information on managing payment methods, see [Manage your payment methods](/guides/platform/manage-your-subscription#manage-your-payment-methods).
...
For more information on credits and credit top-ups, see the [Credits page](/guides/platform/credits).
