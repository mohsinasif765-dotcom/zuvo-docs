...
The Zuvo IPv4 add-on provides a dedicated IPv4 address for your Postgres database connection. It can be configured in the [Add-ons Settings](/dashboard/project/_/settings/addons).
...
2. **Zuvo Client Libraries**: These libraries are compatible with IPv4
