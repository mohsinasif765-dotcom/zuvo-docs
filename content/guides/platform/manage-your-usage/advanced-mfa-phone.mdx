...
You are charged for having the feature [Advanced Multi-Factor Authentication Phone](/guides/auth/auth-mfa/phone) enabled for your project.

<Admonition type="note">

The Advanced MFA Phone add-on is **not** covered by the [Spend Cap](/guides/platform/cost-control#spend-cap).
...
$0.1027 per hour ($75 per month) for the first project.
$0.0137 per hour ($10 per month) for every additional project.
...
For a detailed breakdown of how charges are calculated, refer to [Manage Advanced MFA Phone usage](/guides/platform/manage-your-usage/advanced-mfa-phone).
