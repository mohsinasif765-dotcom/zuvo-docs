...
Each database has a dedicated [disk](/guides/platform/compute-and-disk#disk). You are charged for the provisioned disk size.

<Admonition type="note">

Disk size is not relevant for the Free Plan. Instead Free Plan customers are limited by [Database size](/guides/platform/database-size).
...
Pricing depends on the [disk type](/guides/platform/compute-and-disk#disk-types), with gp3 being the default disk type.
...
Launching a Read Replica creates an additional database with its own dedicated disk. You are charged from the first byte of provisioned disk for the Read Replica. Refer to [Manage Read Replica usage](/guides/platform/manage-your-usage/read-replicas) for details on billing.
...
![Usage page Disk Size section](/img/guides/platform/usage-disk-size--light.png)



### Disk size distribution

To see how your disk usage is distributed across Database, WAL, and System categories, refer to [Disk size distribution](/guides/platform/database-size#disk-size-distribution).

## Reduce Disk size

To see how you can downsize your disk, refer to [Reducing disk size](/guides/platform/database-size#reducing-disk-size)
