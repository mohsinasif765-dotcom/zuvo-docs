...
For simplicity, assume a package size of 1,000 and a charge of $5 per package with no quota.
...
For a detailed breakdown of how charges are calculated, refer to [Manage Storage Image Transformations usage](/guides/platform/manage-your-usage/storage-image-transformations).
...
![Usage page Storage Image Transformations section](/img/guides/platform/usage-image-transformations--light.png)
...
- Leverage [Smart CDN](/guides/storage/cdn/smart-cdn) caching or any other caching solution to serve transformed images efficiently and avoid unnecessary repeated transformations
