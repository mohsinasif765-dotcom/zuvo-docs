...
- **Avoiding frequent programmatic polling.** Repeated API or CLI log queries accumulate GB rapidly. For continuous log streaming, [Log Drains](/guides/platform/manage-your-usage/log-drains) are more cost-effective.
