...
Each [Preview branch](/guides/deployment/branching) is a separate environment with all Zuvo services (Database, Auth, Storage, etc.). You're charged for usage within that environment—such as [Compute](/guides/platform/manage-your-usage/compute), [Disk Size](/guides/platform/manage-your-usage/disk-size), [Egress](/guides/platform/manage-your-usage/egress), and [Storage](/guides/platform/manage-your-usage/storage-size)—the same as the project you branched from.

<Admonition type="note">

Usage by Preview branches counts toward your subscription plan's quota. Branches are **not** covered by the [Spend Cap](/guides/platform/cost-control#spend-cap).

</Admonition>

## How charges are calculated

Refer to individual [usage items](/guides/platform/manage-your-usage) for details on how charges are calculated. Branching charges are the sum of all these items.
...
![Usage summary Branching Compute Hours](/img/guides/platform/usage-summary-branch-hours--light.png)
...
- Check whether your [persistent branches](/guides/deployment/branching#persistent-branches) need to be defined as persistent, or if they can be ephemeral instead. Persistent branches will remain active even after the underlying PR is closed.
