...
Each project on the Zuvo platform includes a dedicated Postgres instance running on its own server. You are charged for the [Compute](/guides/platform/compute-and-disk#compute) resources of that server, independent of your database usage.

<Admonition type="note">

Paused projects do not count towards Compute usage. Compute Hours are **not** covered by the [Spend Cap](/guides/platform/cost-control#spend-cap).
...
![Usage page Compute Hours section](/img/guides/platform/usage-compute--light.png)
...
- [Transfer projects](/guides/platform/project-transfer) to a Free Plan organization to reduce Compute usage
