...
You can assign a dedicated [IPv4 address](/guides/platform/ipv4-address) to a database by enabling the [IPv4 add-on](/dashboard/project/_/settings/addons?panel=ipv4). You are charged for all IPv4 addresses configured across your databases.

<Admonition type="note">

IPv4 Hours are **not** covered by the [Spend Cap](/guides/platform/cost-control#spend-cap).
...
To see whether your database needs a dedicated IPv4 address, refer to [When you need the IPv4 add-on](/guides/platform/ipv4-address#when-you-need-the-ipv4-add-on).
