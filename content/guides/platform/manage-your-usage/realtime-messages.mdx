...
You are charged for the number of messages going through Zuvo Realtime throughout the billing cycle. Includes database changes, Broadcast and Presence.
...
![Usage page Realtime Messages section](/img/guides/platform/usage-realtime-messages--light.png)
