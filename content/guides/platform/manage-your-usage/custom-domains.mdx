...
You can configure a [custom domain](/guides/platform/custom-domains) for a project by enabling the [Custom Domain add-on](/dashboard/project/_/settings/addons?panel=customDomain). You are charged for all custom domains configured across your projects.

<Admonition type="note">

Custom Domains are **not** covered by the [Spend Cap](/guides/platform/cost-control#spend-cap).
...
- Use free [Vanity subdomains](/guides/platform/custom-domains#vanity-subdomains) where applicable
