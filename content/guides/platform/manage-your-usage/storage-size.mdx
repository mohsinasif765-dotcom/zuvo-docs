...
![Usage page Storage Size section](/img/guides/platform/usage-storage-size--light.png)
...
- [Limit the upload size](/guides/storage/production/scaling#limit-the-upload-size) for your buckets
- [Delete assets](/guides/storage/management/delete-objects) that are no longer in use
