...
For a detailed breakdown of how charges are calculated, refer to [Manage Monthly Active SSO Users usage](/guides/platform/manage-your-usage/monthly-active-users-sso).
...
![Usage page Monthly Active SSO Users section](/img/guides/platform/usage-mau-sso--light.png)
