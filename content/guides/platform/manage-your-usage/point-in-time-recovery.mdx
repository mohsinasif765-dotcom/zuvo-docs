...
You can configure [Point-in-Time Recovery (PITR)](/guides/platform/backups#point-in-time-recovery) for a project by enabling the [PITR add-on](/dashboard/project/_/settings/addons?panel=pitr). You are charged for every enabled PITR add-on across your projects.

<Admonition type="note">

Point-In-Time Recovery add-on is **not** covered by the [Spend Cap](/guides/platform/cost-control#spend-cap).
...
- Review your [backup frequency](/guides/platform/backups#frequency-of-backups) needs to determine whether you require PITR or free Daily Backups are sufficient
