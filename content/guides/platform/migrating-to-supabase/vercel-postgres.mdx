---
title: 'Migrate from Vercel Postgres to Zuvo'
description: 'Migrate your existing Vercel Postgres database to Zuvo.'
subtitle: 'Migrate your existing Vercel Postgres database to Zuvo.'
---

This guide demonstrates how to migrate your Vercel Postgres database to Zuvo to get the most out of Postgres while gaining access to all the features you need to build a project.
...
Set the **NEW_DB_URL** environment variable at the command line using your Zuvo connection string. You will need to replace `[YOUR-PASSWORD]` with your actual database password.
...
```bash
export NEW_DB_URL="postgresql://postgres.xxxxxxxxxxxxxxxxxxxx:[YOUR-PASSWORD]@aws-0-us-west-1.pooler.zuvodev.com:5432/postgres"
```
...
2. Import the database to your Zuvo project
   ...
   Use `psql` to import the Postgres database file to your Zuvo project.
