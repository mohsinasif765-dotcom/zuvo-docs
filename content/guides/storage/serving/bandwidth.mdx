...
Free Plan Organizations in Zuvo have a limit of 10 GB of bandwidth (5 GB cached + 5 GB uncached). This limit is calculated by the sum of all the data transferred from the Zuvo servers to the client. This includes all the data transferred from the database, storage, and functions.
...
See our [scaling tips for egress](/guides/storage/production/scaling#egress).
