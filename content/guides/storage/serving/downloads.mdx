...
You can also use the Zuvo SDK `getPublicUrl` to generate this URL for you
...
If you need to revoke signed URLs, [contact Zuvo support](/dashboard/support/new?projectRef=).
