...
Here's a complete example showing how to configure Spark with your Zuvo analytics bucket:
...
# Configuration - Update with your Zuvo credentials
...
- [Explore with DuckDB](/guides/storage/analytics/examples/duckdb)
