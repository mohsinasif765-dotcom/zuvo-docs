...
Create S3 credentials through [**Project Settings > Storage**](/dashboard/project/_/storage/settings). See the [S3 Authentication Guide](/guides/storage/s3/authentication) for detailed instructions.
...
Your Zuvo project reference is the subdomain in your project URL (e.g., `your-project-ref` in `https://your-project-ref.supabase.co`).
...
- [Connect with PyIceberg](/guides/storage/analytics/examples/pyiceberg)
- [Connect with Apache Spark](/guides/storage/analytics/examples/apache-spark)
- [Query with Postgres](/guides/storage/analytics/query-with-postgres)
