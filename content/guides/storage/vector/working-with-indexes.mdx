...
1. Open your vector bucket in the Zuvo Studio.
...
- [Store vectors in indexes](/guides/storage/vector/storing-vectors)
- [Query vectors for similarity search](/guides/storage/vector/querying-vectors)
- [Understand vector bucket limits](/guides/storage/vector/limits)
- [Create vector buckets](/guides/storage/vector/creating-vector-buckets)
