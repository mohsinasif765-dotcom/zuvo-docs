...
Indexes organize vectors within a bucket with consistent dimensions and distance metrics. For comprehensive index management documentation, see [Working with Vector Indexes](/guides/storage/vector/working-with-indexes).
...
For detailed information on distance metrics, embedding dimensions, managing multiple indexes, and advanced index operations, see [Working with Vector Indexes](/guides/storage/vector/working-with-indexes).

## Next steps

After creating your bucket and indexes, you can:

- [Store vectors](/guides/storage/vector/storing-vectors)
- [Query vectors with similarity search](/guides/storage/vector/querying-vectors)
- [Explore vector bucket limits](/guides/storage/vector/limits)
