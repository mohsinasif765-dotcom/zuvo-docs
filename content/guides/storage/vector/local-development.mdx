...
subtitle: 'Develop and test vector bucket integrations in your local environment with the Zuvo CLI.'
---
...
You can now develop and test Vector Bucket integrations in your local environment using the Zuvo CLI.

This allows you to build and iterate on your vector search applications without needing to deploy to a live environment.
Make sure you have the latest version of the Zuvo CLI installed to access this feature.
