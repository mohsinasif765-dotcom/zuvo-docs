...
[`Metabase`](https://www.metabase.com/) is an Open Source data visualization tool. You can use it to explore your data stored in Zuvo.
...
```sh
  ...
  <StepHikeCompact.Step step={2}>
    ...
    <Admonition type="note" title="connection notice">
            ...
            If you're in an [IPv6 environment](/guides/platform/ipv4-address#checking-your-network-ipv6-support) or have the [IPv4 Add-On](/guides/platform/ipv4-address#understanding-ip-addresses), you can use the direct connection string instead of Supavisor in Session mode.
