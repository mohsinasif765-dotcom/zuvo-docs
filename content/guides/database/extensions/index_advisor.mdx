...
`index_advisor` is accessible directly through Zuvo Studio by navigating to the [Query Performance Report](/dashboard/project/_/advisors/query-performance) and selecting a query and then the "indexes" tab.

![Zuvo Studio index_advisor integration.](/docs/img/index_advisor_studio.png)
