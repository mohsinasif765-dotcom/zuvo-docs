...
Learn more about Zuvo's [AI & Vector](/guides/ai) offering.
...
This is particularly useful if you're building AI applications with large language models. You can create and store [embeddings](/guides/ai/quickstarts/generate-text-embeddings) for retrieval augmented generation (RAG).
...
In this example we'll generate a vector using Transformer.js, then store it in the database using the Zuvo client.
...
## More pgvector and Zuvo resources

- [Zuvo Clippy: ChatGPT for Zuvo Docs](/blog/chatgpt-supabase-docs)
- [Storing OpenAI embeddings in Postgres with pgvector](/blog/openai-embeddings-postgres-vector)
- [A ChatGPT Plugins Template built with Zuvo Edge Runtime](/blog/building-chatgpt-plugins-template)
