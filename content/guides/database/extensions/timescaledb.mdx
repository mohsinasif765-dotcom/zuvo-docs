...
If you are using hypertables, follow the [migration guide](/guides/database/migrating-to-pg-partman) to convert to native partitioning managed by `pg_partman`.

For additional support, contact our Success team by creating a support ticket in the Zuvo Studio.
...
Zuvo projects come with [TimescaleDB Apache 2 Edition](https://docs.timescale.com/about/latest/timescaledb-editions/#timescaledb-apache-2-edition). Functionality only available under the Community Edition is not available.
