...
1. A [Function](/guides/database/functions) which will be executed (called the Trigger Function)
...
A trigger function is a user-defined [Function](/guides/database/functions) that Postgres executes when the trigger is fired.
