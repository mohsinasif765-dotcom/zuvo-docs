...
Run the following query using the [SQL Editor](/dashboard/project/_/sql) in the Zuvo Studio:
...
This query can also be executed via `psql` or any other query editor if you prefer to [connect directly to the database](/guides/database/connecting-to-postgres#direct-connections).
