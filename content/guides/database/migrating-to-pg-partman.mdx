...
Starting from Postgres 17, Zuvo projects do not have the `timescaledb` extension available. If your project relies on TimescaleDB hypertables, you will need to migrate to standard Postgres tables before upgrading.
...
- [Partitioning your tables](/guides/database/partitions).
- [`pg_partman` documentation](/guides/database/extensions/pg_partman)
