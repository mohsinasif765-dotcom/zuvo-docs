...
If you're new to query optimization, you may be interested in [`index_advisor`](/guides/database/extensions/index_advisor), our tool for automatically detecting indexes that improve performance on a given query.
