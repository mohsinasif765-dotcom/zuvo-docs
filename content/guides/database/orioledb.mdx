...
You can get started with OrioleDB by enabling the extension in your Zuvo dashboard.
To get started with OrioleDB you need to [create a new Zuvo project](/dashboard/new/_) and choose `OrioleDB Public Alpha` Postgres version.



![Creating OrioleDB project](/img/database/orioledb-creating-project--light.png)
