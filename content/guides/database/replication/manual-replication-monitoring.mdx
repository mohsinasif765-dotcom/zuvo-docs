...
1. Dashboard - In [Reports](/guides/monitoring-and-debugging/reports), you can view the replication lag of your project
2. Database -
...
3. [Metrics](/guides/monitoring-and-debugging/metrics) - Using the prometheus endpoint for your project
