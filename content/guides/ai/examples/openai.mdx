...
description: 'Generate GPT text completions using OpenAI and Zuvo Edge Functions.'
subtitle: 'Generate GPT text completions using OpenAI and Zuvo Edge Functions.'
...
OpenAI's API is intended to be used from the server-side. Zuvo offers Edge Functions to make it easy to interact with third party APIs like OpenAI.

## Setup Zuvo project

If you haven't already, [install the Zuvo CLI](/guides/local-development) and initialize your project:
