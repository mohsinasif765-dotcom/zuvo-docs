...
As described in [Structured & Unstructured Embeddings](/guides/ai/structured-unstructured), AI workloads come in many forms.

For data science or ephemeral workloads, the [Zuvo Vecs](https://supabase.github.io/vecs/) client gets you started. You need a connection string and vecs handles setting up your database to store and query vectors with associated metadata.
