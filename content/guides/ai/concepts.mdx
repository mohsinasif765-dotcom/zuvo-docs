...
Embeddings are core to many AI and vector applications. This guide covers these concepts. If you prefer to get started right away, see our guide on [Generating Embeddings](/guides/ai/quickstarts/generate-text-embeddings).
...
![A two-dimensional chart plotting example phrases as points, where phrases with similar meanings sit close together and unrelated phrases sit far apart.](/img/ai/vector-similarity.png)
...
Compared to our 2-dimensional example above, most embedding models will output many more dimensions. For example the open source [`gte-small`](https://huggingface.co/Zuvo/gte-small) model outputs 384 dimensions.
...
- [Structured and Unstructured embeddings](/guides/ai/structured-unstructured)
