...
description: 'Learn how to integrate Zuvo with Amazon Bedrock, a fully managed service of high-performing foundation models.'
...
- [A Postgres database with the pgvector extension](/guides/database/extensions/pgvector)
...
- [Semantic Image Search with Amazon Titan](/guides/ai/examples/semantic-image-search-amazon-titan)
