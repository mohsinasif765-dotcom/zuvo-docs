...
title: 'Roboflow'
subtitle: 'Learn how to integrate Zuvo with Roboflow, a tool for running fine-tuned and foundation vision models.'
...
The steps below show you how to run a vision model locally and save predictions to Zuvo.
...
### Step 3: Save results in Zuvo

To save results in Zuvo, add the following code to your script:
...
You can use the Zuvo vector database functionality to store and query CLIP embeddings.
...
### Step 3: Save embeddings in Zuvo

You can store your image embeddings in Zuvo using the Zuvo `vecs` Python package:
...
Replace `DB_CONNECTION` with the authentication information for your database. You can retrieve this from the Zuvo dashboard in `Project Settings > Database Settings`.
...
- [How to Build a Semantic Image Search Engine with Zuvo and OpenAI CLIP](https://blog.roboflow.com/how-to-use-semantic-search-supabase-openai-clip/)
