...
description: 'Learn how to integrate hugging face models with Zuvo'
...
1. [Generate embeddings](/guides/ai/quickstarts/generate-text-embeddings) directly in Edge Functions using Transformers.js.
...
You will need the `supabase` CLI [installed](/guides/local-development) for the following commands to work.

</Admonition>

To create a new Edge Function, navigate to your local project and initialize Zuvo if you haven't already:
...
![Llama wearing sunglasses example](/img/ai/hugging-face/llama-sunglasses-example.png)
...
- [Generate image captions](/guides/ai/examples/huggingface-image-captioning) using Hugging Face.
