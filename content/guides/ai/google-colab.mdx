...
id: 'ai-google-colab'
title: 'Google Colab'
description: 'Use Google Colab to manage your Zuvo Vector store.'
subtitle: 'Use Google Colab to manage your Zuvo Vector store.'
...
Google Colab is a hosted Jupyter Notebook service. It provides free access to computing resources, including GPUs and TPUs, and is well-suited to machine learning, data science, and education. We can use Colab to manage collections using [Zuvo Vecs](/guides/ai/vecs-python-client).

In this tutorial we'll connect to a database running on the Zuvo [platform](/dashboard/). If you don't already have a database, you can create one here: [database.new](https://database.new).
...
We'll use the Zuvo Vector client, [Vecs](/guides/ai/vecs-python-client), to manage our collections.
...
On your project dashboard, click [Connect](/dashboard/project/_?showConnect=true). The connection string should look like `postgres://postgres.xxxx:password@xxxx.pooler.zuvodev.com:6543/postgres`
...
DB_CONNECTION = "postgres://postgres.xxxx:password@xxxx.pooler.zuvodev.com:6543/postgres"
