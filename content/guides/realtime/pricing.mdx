...
For a detailed explanation of how charges are calculated, refer to [Manage Realtime Messages usage](/guides/platform/manage-your-usage/realtime-messages).
...
For a detailed explanation of how charges are calculated, refer to [Manage Realtime Peak Connections usage](/guides/platform/manage-your-usage/realtime-peak-connections).
