...
description: 'Architecture of the Zuvo Realtime service'
...
![Architecture](/img/guides/platform/realtime/architecture--light.png)
...
Client-facing WebSocket servers need to handle many concurrent connections. Elixir & Phoenix let the Zuvo Realtime cluster do this easily.
...
Thanks to the Realtime cluster, you (an amazing Zuvo user) don't have to think about which regions your clients are connected to.
...
Broadcast uses [Realtime Authorization](/guides/realtime/authorization) by default to protect your data.
