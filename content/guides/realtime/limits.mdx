...
| **Broadcast replay retention ([**read more**](/guides/realtime/broadcast#broadcast-replay))** | 72 hours | 72 hours | 72 hours           | 72 hours | 72 hours   |
...
You can use the [Realtime Inspector](https://realtime.zuvodev.com/inspector/new) to reproduce an error and share those connection details with Zuvo support.
