...
Realtime reports give insights into how your application uses Zuvo Realtime, including connections, broadcast and change events, execution times, and lag.
...
![Connected Clients chart](/img/guides/platform/realtime/reports/connected-clients-chart-light.png)
...
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Configure connection limit  | Adjust the "Max concurrent connections" setting to increase or decrease the connection limit for your project                                                | [Realtime Settings Guide](/guides/realtime/settings)                                                                                                     |
...
| Review quotas               | Understand connection limits and other Realtime quotas for your plan                                                                                         | [Realtime Quotas Reference](/guides/realtime/limits)                                                                                                     |
| Understand connection quota | Learn how the concurrent connections quota works and how to configure it for your plan                                                                       | [Concurrent Peak Connections Quota Troubleshooting](/guides/troubleshooting/realtime-concurrent-peak-connections-quota-jdDqcp)                           |
| Fix silent disconnections   | Fix connection issues in background applications using heartbeat callbacks and Web Workers                                                                   | [Handling Silent Disconnections in Background Apps](/guides/troubleshooting/realtime-handling-silent-disconnections-in-backgrounded-applications-592794) |
...
![Broadcast Events chart](/img/guides/platform/realtime/reports/broadcast-events-chart-light.png)
...
| Action                 | Description                                                                                                                                                          | More information                                                                              |
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| Configure event limits | Adjust "Max events per second" and "Max payload size in KB" settings to optimize broadcast throughput and message size limits                                        | [Realtime Settings Guide](/guides/realtime/settings)                                     |
| Review quotas          | Understand message per second limits (Free: 100, Pro: 500, Pro no spend cap/Team/Enterprise: 2,500) and broadcast payload size limits (Free: 256 KB, Pro+: 3,000 KB) | [Realtime Quotas Reference](/guides/realtime/limits)                                     |
...
| Debug with logger      | Enable logging to track messages sent and received, and diagnose broadcast delivery issues                                                                           | [Debugging Realtime with Logger](/guides/troubleshooting/realtime-debugging-with-logger) |
| Learn broadcast basics | Understand how to implement and optimize broadcast messaging in your application                                                                                     | [Broadcast Guide](/guides/realtime/broadcast)                                            |
...
![Presence Events chart](/img/guides/platform/realtime/reports/presence-events-chart-light.png)
...
| Action                    | Description                                                                                                                                                         | More information                                                                              |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| Configure presence limits | Adjust the "Max presence events per second" setting to optimize presence state update throughput                                                                    | [Realtime Settings Guide](/guides/realtime/settings)                                     |
| Review quotas             | Understand presence messages per second limits (Free: 20, Pro: 50, Pro no spend cap/Team/Enterprise: 1,000) and presence keys per object limits (10 for most plans) | [Realtime Quotas Reference](/guides/realtime/limits)                                     |
...
| Debug with logger         | Enable logging to track presence events and diagnose state synchronization issues                                                                                   | [Debugging Realtime with Logger](/guides/troubleshooting/realtime-debugging-with-logger) |
| Learn presence basics     | Understand how to implement and optimize presence state tracking in your application                                                                                | [Presence Guide](/guides/realtime/presence)                                              |
...
![Postgres Changes Events chart](/img/guides/platform/realtime/reports/postgres-changes-events-chart-light.png)
...
| Action                   | Description                                                                                           | More information                                                                                       |
| ------------------------ | ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| Review quotas            | Understand Postgres change payload size limits (1,024 KB for all plans) and message throughput limits | [Realtime Quotas Reference](/guides/realtime/limits)                                              |
...
| Learn Postgres Changes   | Understand limitations and best practices for using Postgres Changes                                  | [Postgres Changes Guide](/guides/realtime/postgres-changes)                                       |
| Migrate to Broadcast     | For better scalability, consider using Broadcast with database triggers instead of Postgres Changes   | [Broadcast Guide](/guides/realtime/broadcast)                                                     |
| Create database triggers | Understand how to create triggers that can send Broadcast messages on database events                 | [Database Triggers Guide](/guides/database/postgres/triggers)                                     |
| Monitor replication      | Monitor logical replication health and lag since Postgres Changes reads from the WAL                  | [manual replication monitoring guide](/guides/database/replication/manual-replication-monitoring) |
...
![Rate of Channel Joins chart](/img/guides/platform/realtime/reports/rate-of-channel-joins-chart-light.png)
...
| Action               | Description                                                                                                                                                       | More information                                                                                       |
| -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| Review quotas        | Understand channel joins per second limits (Free: 100, Pro: 500, Pro no spend cap/Team/Enterprise: 2,500) and channels per connection limits (100 for most plans) | [Realtime Quotas Reference](/guides/realtime/limits)                                              |
...
| Fix channel errors   | Learn how to properly manage channel lifecycle and prevent channel leaks in your application                                                                      | [TooManyChannels Error Troubleshooting](/guides/troubleshooting/realtime-too-many-channels-error) |
| Learn channel basics | Understand how Realtime channels work and best practices for channel management                                                                                   | [Realtime Channels Concepts](/guides/realtime/concepts#channels)                                  |
...
![Message Payload Size chart](/img/guides/platform/realtime/reports/message-payload-size-chart-light.png)
...
| Action                   | Description                                                                                                            | More information                                                                                         |
| ------------------------ | ---------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| Configure payload limits | Adjust the "Max payload size in KB" setting to increase or decrease the maximum message size allowed                   | [Realtime Settings Guide](/guides/realtime/settings)                                                |
| Review quotas            | Understand payload size limits: Broadcast (Free: 256 KB, Pro+: 3,000 KB) and Postgres Changes (1,024 KB for all plans) | [Realtime Quotas Reference](/guides/realtime/limits)                                                |
...
| Review benchmarks        | Understand how payload size affects latency and throughput (larger payloads increase latency)                          | [Payload Size Performance Benchmarks](/guides/realtime/benchmarks#broadcast-impact-of-payload-size) |
| Debug query performance  | Use `explain()` to analyze queries and identify performance bottlenecks that may be causing large payloads             | [Query Performance Debugging Guide](/guides/database/debugging-performance)                         |
| Learn broadcast basics   | Understand best practices for structuring broadcast messages and optimizing payload sizes                              | [Broadcast Guide](/guides/realtime/broadcast)                                                       |
...
![Broadcast from Database Replication Lag chart](/img/guides/platform/realtime/reports/broadcast-from-database-replication-lag-chart-light.png)
...
| Review replication metrics | Use `pg_stat_subscription`, `pg_replication_slots`, and other Postgres views to diagnose replication issues | [manual replication monitoring guide](/guides/database/replication/manual-replication-monitoring)         |
| Debug database issues      | Use CLI inspection tools to identify bloat, lock contention, and long-running queries affecting replication | [Database Inspection Tools Guide](/guides/database/inspect)                                               |
| Optimize performance       | Optimize query performance and connection management to reduce database load                                | [Performance Tuning Guide](/guides/platform/performance)                                                  |
| Configure timeouts         | Configure statement timeouts to prevent long-running transactions from blocking replication                 | [Database Timeouts Guide](/guides/database/postgres/timeouts)                                             |
| Learn broadcast from DB    | Understand how broadcast from database works and best practices for implementation                          | [Broadcast from Database Guide](/guides/realtime/broadcast#trigger-broadcast-messages-from-your-database) |
...
![(Read) Private Channel Subscription RLS Execution Time chart](/img/guides/platform/realtime/reports/read-private-channel-subscription-rls-execution-time-chart-light.png)
...
| Action                     | Description                                                                                                                                                                                          | More information                                                                                         |
| -------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| Configure connection pool  | Adjust the "Database connection pool size" setting to increase the number of connections available for RLS authorization checks, which can improve performance for high-volume channel subscriptions | [Realtime Settings Guide](/guides/realtime/settings)                                                |
| Optimize RLS policies      | Learn how to optimize RLS policies with indexes, function wrapping, and query optimization techniques                                                                                                | [RLS Performance Best Practices](/guides/troubleshooting/rls-performance-and-best-practices-Z5Jjwv) |
...
| Learn authorization basics | Understand how RLS policies work with private channels and best practices for implementation                                                                                                         | [Realtime Authorization Guide](/guides/realtime/authorization)                                      |
| Create indexes             | Add indexes on columns frequently used in RLS policy conditions to speed up authorization checks                                                                                                     | [Database Indexes Guide](/guides/database/postgres/indexes)                                         |
| Use index advisor          | Automatically detect missing indexes that could improve RLS policy performance                                                                                                                       | [Index Advisor Extension Guide](/guides/database/extensions/index_advisor)                          |
| Optimize queries           | Learn techniques for optimizing queries including partial indexes and composite indexes for RLS conditions                                                                                           | [Query Optimization Guide](/guides/database/query-optimization)                                     |
...
![(Write) Private Channel Subscription RLS Execution Time chart](/img/guides/platform/realtime/reports/write-private-channel-subscription-rls-execution-time-chart-light.png)
...
| Action                     | Description                                                                                                                                                                                          | More information                                                                                         |
| -------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| Configure connection pool  | Adjust the "Database connection pool size" setting to increase the number of connections available for RLS authorization checks, which can improve performance for high-frequency message publishing | [Realtime Settings Guide](/guides/realtime/settings)                                                |
| Optimize RLS policies      | Learn how to optimize RLS policies with indexes, function wrapping, and query optimization techniques                                                                                                | [RLS Performance Best Practices](/guides/troubleshooting/rls-performance-and-best-practices-Z5Jjwv) |
...
| Learn authorization basics | Understand how RLS policies work with private channels for write operations and best practices for implementation                                                                                    | [Realtime Authorization Guide](/guides/realtime/authorization)                                      |
| Create indexes             | Add indexes on columns used in INSERT policies to speed up write authorization checks                                                                                                                | [Database Indexes Guide](/guides/database/postgres/indexes)                                         |
| Use index advisor          | Automatically detect missing indexes that could improve write RLS policy performance                                                                                                                 | [Index Advisor Extension Guide](/guides/database/extensions/index_advisor)                          |
| Optimize queries           | Learn techniques for optimizing INSERT policy queries including partial indexes for specific conditions                                                                                              | [Query Optimization Guide](/guides/database/query-optimization)                                     |
...
![Total Requests chart](/img/guides/platform/realtime/reports/total-requests-chart-light.png)
...
| Learn REST API broadcast | Understand how to send broadcast messages using HTTP requests                | [Broadcast via REST API Guide](/guides/realtime/broadcast#broadcast-via-rest-api) |
...
![Response Errors chart](/img/guides/platform/realtime/reports/response-errors-chart-light.png)
...
| Action                  | Description                                                                                                                 | More information                                                                                                  |
| ----------------------- | --------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| Configure limits        | Adjust "Max concurrent connections" or "Max events per second" settings if errors are related to quota limits being reached | [Realtime Settings Guide](/guides/realtime/settings)                                                         |
...
| Understand error codes  | Understand specific error codes and their resolutions                                                                       | [Realtime Error Codes Reference](/guides/realtime/error_codes)                                               |
| Learn HTTP status codes | Learn about HTTP status codes including 4XX client errors and 5XX server errors                                             | [HTTP Status Codes Troubleshooting](/guides/troubleshooting/http-status-codes)                               |
| Fix timeout errors      | Resolve WebSocket timeout errors caused by Node.js version incompatibility                                                  | [TIMED_OUT Connection Errors Troubleshooting](/guides/troubleshooting/realtime-connections-timed_out-status) |
| Understand heartbeats   | Monitor heartbeat status to detect connection issues and handle timeouts                                                    | [Realtime Heartbeats Guide](/guides/troubleshooting/realtime-heartbeat-messages)                             |
| Review quotas           | Check if errors are related to quota limits (e.g., `too_many_connections`, `too_many_joins`)                                | [Realtime Quotas Reference](/guides/realtime/limits)                                                         |
| Learn authorization     | Troubleshoot authorization-related errors for private channels                                                              | [Realtime Authorization Guide](/guides/realtime/authorization)                                               |
...
![Response Speed chart](/img/guides/platform/realtime/reports/response-speed-chart-light.png)
...
| Action                    | Description                                                                                                                                         | More information                                                                                         |
| ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| Configure connection pool | Adjust the "Database connection pool size" setting to optimize database connection usage, which can improve response times for authorization checks | [Realtime Settings Guide](/guides/realtime/settings)                                                |
...
| Review benchmarks         | Understand expected latency and throughput for different Realtime operations                                                                        | [Realtime Performance Benchmarks](/guides/realtime/benchmarks)                                      |
| Understand heartbeats     | Monitor heartbeat status and customize intervals to balance detection speed with network overhead                                                   | [Realtime Heartbeats Guide](/guides/troubleshooting/realtime-heartbeat-messages)                    |
| Optimize RLS policies     | If using private channels, optimize RLS policies that may be slowing down authorization checks                                                      | [RLS Performance Best Practices](/guides/troubleshooting/rls-performance-and-best-practices-Z5Jjwv) |
