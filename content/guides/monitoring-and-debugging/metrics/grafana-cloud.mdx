...
description: 'Use Grafana Cloud’s managed Prometheus to visualize Zuvo metrics'
---
...
The Grafana Cloud integration is available in the Zuvo Studio. [Add the integration](/dashboard/project/_/integrations/grafana-cloud/overview?utm_source=metrics-api&utm_medium=docs&utm_campaign=supabase_grafana_cloud_one_click_integration) and select a project to get a fully-configured instance in one click: authentication, metric scraping, and a pre-built dashboard tracking 200+ metrics, set up automatically.
