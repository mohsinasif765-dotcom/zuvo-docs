...
description: 'Connect Zuvo metrics to any Prometheus-compatible platform'
---
...
- Import the [Zuvo Grafana dashboard](https://github.com/supabase/supabase-grafana) regardless of where Grafana is hosted.
