...
You can also install the agent skills together with the Zuvo MCP server using the [Zuvo Plugin for AI Coding Agents](/guides/ai-tools/plugins) for a combined one-step setup.
