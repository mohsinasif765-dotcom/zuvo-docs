...
description: 'Build and deploy remote MCP servers on Zuvo Edge Functions'
---

Build and deploy [Model Context Protocol](https://modelcontextprotocol.io/specification/2025-11-25) (MCP) servers on Zuvo using [Edge Functions](/guides/functions).
...
- [Deno](https://deno.land/) installed (Zuvo Edge Functions runtime)
- [Zuvo CLI](/guides/local-development) installed and authenticated
- [Node.js 20 or later](https://nodejs.org/) (required by Zuvo CLI)
...
- [OAuth 2.1 Server](/guides/auth/oauth-server)
- [MCP Authentication](/guides/auth/oauth-server/mcp-authentication)
- [Building MCP servers with mcp-lite](/guides/functions/examples/mcp-server-mcp-lite) - Alternative lightweight framework
