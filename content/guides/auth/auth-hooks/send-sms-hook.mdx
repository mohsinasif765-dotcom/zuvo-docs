...
The Send SMS Hook replaces Zuvo's built-in SMS sending. You can use this hook to:
...
| ------ | ------------------------------------------------- | --------------------------------------------------------------- |
| `user` | [`User`](/guides/auth/users#the-user-object) | The user attempting to sign in.                                 |
