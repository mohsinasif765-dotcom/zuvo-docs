...
- [Clerk](/guides/auth/third-party/clerk)
- [Firebase Auth](/guides/auth/third-party/firebase-auth)
- [Auth0](/guides/auth/third-party/auth0)
- [AWS Cognito (with or without AWS Amplify)](/guides/auth/third-party/aws-cognito)
- [WorkOS](/guides/auth/third-party/workos)

You can use these providers alongside Zuvo Auth, or on their own, to access the [Data API (REST and GraphQL)](/guides/database/overview), [Storage](/guides/storage), [Realtime](/guides/storage) and [Functions](/guides/functions) from your existing apps.
