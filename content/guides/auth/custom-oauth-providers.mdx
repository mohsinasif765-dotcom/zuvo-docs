...
description: 'Add any OAuth2 or OIDC-compatible identity provider to your Zuvo project'
---

Custom OAuth/OIDC providers let you integrate any standards-compliant identity provider with Zuvo Auth, beyond the ones Zuvo supports out of the box.
...
Or using the Zuvo client libraries:
