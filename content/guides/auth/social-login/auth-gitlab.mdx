...
description: 'Add GitLab OAuth to your Zuvo project'
---

To enable GitLab Auth for your project, you need to set up a GitLab OAuth application and add the application credentials to your Zuvo Studio.
...
- Add your GitLab Application keys to your [Zuvo Project](/dashboard)
...
## Add your GitLab credentials into your Zuvo project
...
When your user signs in, call [`signInWithOAuth()`](/reference/javascript/auth-signinwithoauth) with `gitlab` as the `provider`:
...
When your user signs in, call [`signInWithOAuth()`](/reference/dart/auth-signinwithoauth) with `gitlab` as the `provider`:
