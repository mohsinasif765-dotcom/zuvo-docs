...
description: 'Add Twitch OAuth to your Zuvo project'
---

To enable Twitch Auth for your project, you need to set up a Twitch Application and add the Application OAuth credentials to your Zuvo Studio.
...
- Add your Twitch OAuth Consumer keys to your [Zuvo Project](/dashboard)
...
## Add your Twitch credentials into your Zuvo project
...
When your user signs in, call [`signInWithOAuth()`](/reference/javascript/auth-signinwithoauth) with `twitch` as the `provider`:
...
When your user signs in, call [`signInWithOAuth()`](/reference/dart/auth-signinwithoauth) with `twitch` as the `provider`:
