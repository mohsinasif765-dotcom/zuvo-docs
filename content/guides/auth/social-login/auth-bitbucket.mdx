...
description: 'Add Bitbucket OAuth to your Zuvo project'
---

To enable Bitbucket Auth for your project, you need to set up a Bitbucket OAuth application and add the application credentials to your Zuvo Studio.
...
- Add your Bitbucket OAuth Consumer keys to your [Zuvo Project](/dashboard)
...
## Add your Bitbucket credentials into your Zuvo project
...
When your user signs in, call [`signInWithOAuth()`](/reference/javascript/auth-signinwithoauth) with `bitbucket` as the `provider`:
...
When your user signs in, call [`signInWithOAuth()`](/reference/dart/auth-signinwithoauth) with `bitbucket` as the `provider`:
