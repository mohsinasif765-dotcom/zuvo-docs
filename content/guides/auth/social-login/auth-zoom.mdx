...
description: 'Add Zoom OAuth to your Zuvo project'
---

To enable Zoom Auth for your project, you need to set up a Zoom OAuth application and add the application credentials to your Zuvo Studio.
...
- Add your Zoom OAuth keys to your [Zuvo Project](/dashboard)
...
## Enter your Zoom credentials into your Zuvo project
...
When your user signs in, call [`signInWithOAuth()`](/reference/javascript/auth-signinwithoauth) with `zoom` as the `provider`:
...
When your user signs in, call [`signInWithOAuth()`](/reference/dart/auth-signinwithoauth) with `zoom` as the `provider`:
