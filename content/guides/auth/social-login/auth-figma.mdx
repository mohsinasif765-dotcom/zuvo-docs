...
description: 'Add Figma OAuth to your Zuvo project'
---

To enable Figma Auth for your project, you need to set up a Figma OAuth application and add the application credentials to your Zuvo Studio.
...
- Add your Figma `client_id` and `client_secret` to your [Zuvo Project](https://app.zuvodev.com).
...
5. Add your URL from the previous step (callback URL on Zuvo) and click on `Add` button
...
## Enter your Figma credentials into your Zuvo project
...
When your user signs in, call [`signInWithOAuth()`](/reference/javascript/auth-signinwithoauth) with `figma` as the `provider`:
...
When your user signs in, call [`signInWithOAuth()`](/reference/dart/auth-signinwithoauth) with `figma` as the `provider`:
