...
description: 'Add X / Twitter OAuth to your Zuvo project'
---

To enable X / Twitter Auth for your project, you need to set up an X OAuth 2.0 application and add the application credentials in the Zuvo Studio.
...
- Add your X OAuth 2.0 `Client ID` and `Client Secret` to your [Zuvo Project](/dashboard).
...
## Enter your X credentials into your Zuvo project
...
When your user signs in, call [`signInWithOAuth()`](/reference/javascript/auth-signinwithoauth) with `x` as the `provider`:
...
When your user signs in, call [`signInWithOAuth()`](/reference/dart/auth-signinwithoauth) with `x` as the `provider`:
