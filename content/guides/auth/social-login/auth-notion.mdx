...
description: 'Add Notion OAuth to your Zuvo project'
---

To enable Notion Auth for your project, you need to set up a Notion Application and add the Application OAuth credentials to your Zuvo Studio.
...
- Retrieve your OAuth client ID and OAuth client secret and add them to your [Zuvo Project](/dashboard)
...
## Add your Notion credentials into your Zuvo project
...
When your user signs in, call [`signInWithOAuth()`](/reference/javascript/auth-signinwithoauth) with `notion` as the `provider`:
...
When your user signs in, call [`signInWithOAuth()`](/reference/dart/auth-signinwithoauth) with `notion` as the `provider`:
