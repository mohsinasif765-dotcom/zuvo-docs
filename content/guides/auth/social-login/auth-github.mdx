...
description: 'Add GitHub OAuth to your Zuvo project'
---

To enable GitHub Auth for your project, you need to set up a GitHub OAuth application and add the application credentials to your Zuvo Studio.
...
- Add your GitHub OAuth keys to your [Zuvo Project](/dashboard)
...
## Enter your GitHub credentials into your Zuvo project
...
When your user signs in, call [`signInWithOAuth()`](/reference/javascript/auth-signinwithoauth) with `github` as the `provider`:
...
When your user signs in, call [`signInWithOAuth()`](/reference/dart/auth-signinwithoauth) with `github` as the `provider`:
