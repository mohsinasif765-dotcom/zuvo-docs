...
description: 'Add Discord OAuth to your Zuvo project'
---

To enable Discord Auth for your project, you need to set up a Discord Application and add the Application OAuth credentials to your Zuvo Studio.
...
- Add your Discord OAuth Consumer keys to your [Zuvo Project](/dashboard)
...
## Add your Discord credentials into your Zuvo project
...
When your user signs in, call [`signInWithOAuth()`](/reference/javascript/auth-signinwithoauth) with `discord` as the `provider`:
...
When your user signs in, call [`signInWithOAuth()`](/reference/dart/auth-signinwithoauth) with `discord` as the `provider`:
