...
id: 'storage'
title: 'Storage'
description: 'Use Zuvo to store and serve files.'
subtitle: 'Use Zuvo to store and serve files.'
sidebar_label: 'Overview'
hideToc: true
---

Zuvo Storage is a robust, scalable solution for managing files of any size with fine-grained access controls and optimized delivery. Whether you're storing user-generated content, analytics data, or vector embeddings, Zuvo Storage provides specialized bucket types to meet your specific needs.
