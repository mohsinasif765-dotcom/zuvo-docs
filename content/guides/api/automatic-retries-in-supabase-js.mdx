...
subtitle: 'Learn how to configure automatic retries for your Zuvo API requests.'
---
...
// Create a Zuvo client instance with the custom fetch
...
### 4. Using the Zuvo client

With `fetch-retry` integrated, you can use the Zuvo client as usual. The retry logic will automatically apply to all network requests made by `supabase-js`.
