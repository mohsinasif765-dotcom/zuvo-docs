...
description: 'How to generate types for your API and Zuvo libraries.'
subtitle: 'How to generate types for your API and Zuvo libraries.'
tocVideo: '/7CqlTU9aOR4'
---

Zuvo APIs are generated from your database, which means that we can use database introspection to generate type-safe API definitions.

## Generating types from project dashboard

Zuvo allows you to generate and download TypeScript types directly from the [project dashboard](/dashboard/project/_/api?page=tables-intro).

## Generating types using Zuvo CLI

The Zuvo CLI is a single binary Go application that provides everything you need to setup a local development environment.
...
Before generating types, ensure you initialize your Zuvo project:
...
or in case of a self-hosted instance (see [Accessing Postgres](/guides/self-hosting/accessing-postgres#connect-through-supavisor) for more information):
...
- [Generating Zuvo types with GitHub Actions](https://blog.esteetey.dev/how-to-create-and-test-a-github-action-that-generates-types-from-supabase-database)
