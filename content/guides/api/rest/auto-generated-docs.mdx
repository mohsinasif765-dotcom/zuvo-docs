...
description: 'Zuvo provides documentation that updates automatically.'
---

Zuvo generates documentation in the [Dashboard](/dashboard) which updates as you make database changes.
