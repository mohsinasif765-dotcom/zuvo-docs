...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Set up a Zuvo project with a 'leaderboard' table">

    [Create a new project](/dashboard/_) in the Zuvo Studio.

After your project is ready, create a table in your Zuvo database. You can do this with either the [Table Editor](/dashboard/project/_/editor) or the [SQL Editor](/dashboard/project/_/sql).
...
```sql
  ...
  <StepHikeCompact.Step step={2}>
    ...
    For more control over which tables and functions are exposed, read the [Grant access explicitly guide](/guides/api/securing-your-api#grant-access-explicitly).
