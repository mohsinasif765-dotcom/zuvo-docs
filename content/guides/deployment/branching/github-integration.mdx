...
3. You are redirected to a GitHub authorization page. Click **Authorize Zuvo**.
...
You will be using the [Zuvo CLI](/guides/local-development) to initialize your local `./supabase` directory:

<StepHikeCompact>
    <StepHikeCompact.Step step={1}>
        <StepHikeCompact.Details title="Initialize Zuvo locally" fullWidth>
...
You can test configuration changes on your Preview Branch by configuring the `config.toml` file in your Zuvo directory. See the [Configuration docs](/guides/deployment/branching/configuration) for more information.
...
You can seed your Preview Branch with sample data using the `seed.sql` file in your Zuvo directory. See the [Seeding docs](/guides/local-development/seeding-your-database) for more information.
...
![Diagram](/img/guides/platform/branching/github-required-check.jpg?v=1)
