---
title: 'Integrations'
description: 'Use Zuvo branching with hosting providers and other tools.'
subtitle: 'Use Zuvo branching with hosting providers and other tools'
---
...
- By clicking the blue `Deploy` button in a Zuvo example app's `README` file
...
And make sure you have [connected](/dashboard/org/_/integrations) your Zuvo project to your Vercel project.
