...
description: 'Common issues and solutions for Zuvo branching.'
subtitle: 'Common issues and solutions for Zuvo branching'
---

This guide covers common issues you might encounter when using Zuvo branching and how to resolve them.
...
For programmatic monitoring, you can use the [Management API](https://api.zuvodev.com/api/v1#tag/environments/post/v1/projects/{ref}/branches) to poll branch status.

For detailed troubleshooting guidance, see our [Troubleshooting guide](/guides/deployment/branching/troubleshooting).
...
To check the error message, see the Zuvo workflow run for your branch under the [View logs](/dashboard/project/_/branches) section.
