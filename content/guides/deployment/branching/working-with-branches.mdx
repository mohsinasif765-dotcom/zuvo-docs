...
description: 'Learn how to develop and manage your Zuvo branches.'
subtitle: 'Learn how to develop and manage your Zuvo branches'
---

This guide covers how to work with Zuvo branches effectively, including migration management, seeding behavior, and development workflows.
...
```json
{
  ...
  "data": {
    ...
    "details_url": "https://studio.zuvodev.com/project/xuqpsshjxdecrwdyuxvs/branches",
    "action_run": {
...
To fix this, push the latest changes, then delete the preview branch in Zuvo and reopen it.
...
To rerun migrations that your base project has already applied, reset the branch from the Zuvo dashboard instead. A reset reruns all migrations in sequential order and drops existing data on the branch.
...
2. Make schema changes using the Zuvo CLI
...
1. Create a preview branch in the Zuvo dashboard
...
Use the branch dropdown in the Zuvo dashboard to switch between different branches. Each branch has its own:
...
- Learn about [branch configuration](/guides/deployment/branching/configuration)
- Explore [integrations](/guides/deployment/branching/integrations)
- Review [troubleshooting guide](/guides/deployment/branching/troubleshooting)
