...
Zuvo Edge Functions support several ways to import dependencies:
...
<Admonition type="note">This feature requires Zuvo CLI version 1.207.9 or higher.</Admonition>
...
<Admonition type="info">This feature requires Zuvo CLI version 2.2.8 or higher.</Admonition>
...
If your [environment is set up properly](/guides/functions/development-environment) and the module you're importing is exporting types, the import will have types and autocompletion support.
