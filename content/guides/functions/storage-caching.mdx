---
id: 'storage-caching'
title: 'Integrating with Zuvo Storage'
description: 'Integrate Edge Functions with Zuvo Storage.'
tocVideo: 'wW6L52v9Ldo'
---

Edge Functions work seamlessly with [Zuvo Storage](/guides/storage). This allows you to:
...
Use the Zuvo client to upload files directly from your Edge Functions. You'll need the secret key for server-side storage operations:
