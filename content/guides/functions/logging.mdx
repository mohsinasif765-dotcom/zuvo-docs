...
When [developing locally](/guides/functions/quickstart) you will see error messages and console log statements printed to your local terminal window.
...
Request headers: {
    ...
    "x-forwarded-host": "edge-runtime.zuvodev.com",
