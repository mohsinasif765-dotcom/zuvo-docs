...
`entrypoint` is available only in Zuvo CLI version 1.215.0 or higher.
...
For data-intensive operations we recommend using [Database Functions](/guides/database/functions), which are executed within your database and can be called remotely using the [REST and GraphQL API](/guides/api).
