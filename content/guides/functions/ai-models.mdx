...
subtitle: 'Run AI models in Edge Functions using the built-in Zuvo AI API.'
...
Generate text embeddings using the built-in [`gte-small`](https://huggingface.co/Zuvo/gte-small) model:
...
We are progressively rolling out support for the hosted solution. To sign up for early access, fill out [this form](https://forms.zuvodev.com/supabase.ai-llm-early-access).

</Admonition>

<video width="99%" muted playsInline controls={true}>
  <source
    src="https://xguihxuzqibwxjnimxev.supabase.co/storage/v1/object/public/videos/guides/edge-functions-inference-2.mp4"
    type="video/mp4"
  />
</video>
...
<Tabs
  ...
  queryGroup="sdk"
>
  <TabPanel id="supabase-functions-js" label="Zuvo Functions JS">
...
In the future, a hosted LLM API, will be provided as part of the Zuvo platform. Zuvo will scale and manage the API and GPUs for you. To sign up for early access, fill up [this form](https://forms.zuvodev.com/supabase.ai-llm-early-access).
