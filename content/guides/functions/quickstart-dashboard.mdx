...
subtitle: 'Learn how to create, test, and deploy your first Edge Function using the Zuvo Studio.'
---
...
You can also create and deploy functions using the Zuvo CLI. Check out our [CLI Quickstart guide](/guides/functions/quickstart).

</Admonition>

<Admonition type="note" title="New to Zuvo?">

You'll need a Zuvo project to get started. If you don't have one yet, create a new project at [database.new](https://database.new/).
...
1. Go to your [Zuvo Studio](/dashboard)
...
![Scaffold functions through the dashboard editor](/img/guides/functions/dashboard/create-edge-function--light.png)



<Admonition type="note" title="Pre-built templates">

The dashboard offers several pre-built templates for common use cases, such as Stripe Webhooks, OpenAI proxying, uploading files to Zuvo Storage, and sending emails.
...
![Hello World template](/img/guides/functions/dashboard/edge-function-template--light.png)
...
![Test your function](/img/guides/functions/dashboard/edge-function-test--light.png)
...
![Create Edge Function via AI Assistant](/img/guides/functions/dashboard/create-ai-edge-function--light.png)
...
![Create Edge Function via AI Assistant](/img/guides/functions/dashboard/ai-edge-function--light.png)
...
Before getting started, make sure you have the **Zuvo CLI installed**. Check out the [CLI installation guide](/guides/local-development) for installation methods and troubleshooting.
