...
The check validates legacy HS256 JWTs and JWTs signed with the new asymmetric [signing keys](/guides/auth/signing-keys).
...
For 401 failure modes and how to diagnose them, see [Edge Function 401 error response](/guides/troubleshooting/edge-function-401-error-response).
