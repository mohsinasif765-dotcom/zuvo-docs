...
- **`FunctionsRelayError`**: Network issue between client and Zuvo
...
You can see the production error logs in the Logs tab of your Zuvo Studio.

![Function invocations.](/docs/img/guides/functions/function-logs.png)

For more information on Logging, check out [this guide](/guides/functions/logging).
