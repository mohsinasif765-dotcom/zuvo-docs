...
[Resumable WebSockets with Edge Functions](/guides/functions/examples/resumable-websockets).
...
for the [OpenAI Realtime API](https://platform.openai.com/guides/realtime/overview).
...
params or via a custom protocol. The [`withZuvo`](/guides/functions/auth)
...
[limits](/guides/functions/limits).
...
When testing Edge Functions locally with Zuvo CLI, the instances are terminated
