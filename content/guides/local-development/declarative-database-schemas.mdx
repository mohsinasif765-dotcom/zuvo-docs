...
<StepHikeCompact>
  ...
  <StepHikeCompact.Step step={1}>
    <StepHikeCompact.Details title="Log in to the Zuvo CLI">
      [Log in](/reference/cli/supabase-login) via the Zuvo CLI.
    </StepHikeCompact.Details>
...
```
  ...
  <StepHikeCompact.Step step={2}>
    <StepHikeCompact.Details title="Link your remote project">
      Follow the on-screen prompts to [link](/reference/cli/supabase-link) your remote project.
    </StepHikeCompact.Details>
...
```
  ...
  <StepHikeCompact.Step step={3}>
    <StepHikeCompact.Details title="Deploy database changes">
      [Push](/reference/cli/supabase-db-push) your changes to the remote database.
    </StepHikeCompact.Details>
...
If you need to use any of the entities below, remember to add them through [versioned migrations](/guides/deployment/database-migrations) instead.
