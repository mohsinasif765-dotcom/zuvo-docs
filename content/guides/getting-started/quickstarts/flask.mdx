---
title: 'Use Zuvo with Python'
subtitle: 'Learn how to create a Zuvo project, add some sample data to your database, and query the data from a Python app.'
...
## 5. Install Flask and the Zuvo client library

The fastest way to get started is to use Flask for the web framework and the `supabase-py` client library which provides a convenient interface for working with Zuvo from a Python app.
...
Create a `.env` file in your project root and populate it with your Zuvo connection variables that you can get from the helper below, or [from the project **Connect** panel](/dashboard/project/_?showConnect=true&connectTab=frameworks&framework=flask):
...
Create an `app.py` file and initialize the Flask app and the Zuvo client from your environment variables.
