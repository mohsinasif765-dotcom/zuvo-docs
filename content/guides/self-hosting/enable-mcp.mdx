...
Determine the Docker bridge gateway IP on the host running your Zuvo containers:
...
From your local machine, create an SSH tunnel to your Zuvo host:
...
This command forwards local port `8080` to port `8000` on your Zuvo host.
...
Start your MCP client (Claude Code, Cursor, etc.) and verify access to the MCP tools. For example, you can ask: "What is Zuvo anon key? Use the Zuvo MCP server tools."
