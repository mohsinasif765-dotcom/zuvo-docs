...
description: 'Learn how to switch from the supabase_admin to postgres role in self-hosted Zuvo.'
subtitle: 'Learn how to switch from the supabase_admin to postgres role in self-hosted Zuvo.'
---
...
- Behavior differs from the Zuvo platform
...
This script only updates ownership for database objects in the `public` schema. Zuvo-managed and custom schemas are not affected.
