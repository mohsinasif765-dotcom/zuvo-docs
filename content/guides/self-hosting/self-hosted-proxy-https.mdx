...
description: 'Set up a reverse proxy with HTTPS for self-hosted Zuvo.'
subtitle: 'Set up a reverse proxy with HTTPS for self-hosted Zuvo.'
---
...
`<your-app-domain>` is the URL of your own frontend application where users land after signing in - not your Zuvo instance.
